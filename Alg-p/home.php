...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <p>Learn </p>
         <div class="flex-box">
            <a href="category.php?category=Algorithm" class="links">Algorithm</a>
            <a href="category.php?category=education" class="links">Data Structure</a>
            <a href="category.php?category=business" class="links">STL</a>
            <a href="category.php?category=travel" class="links">Discete Mathematics</a>
            <a href="category.php?category=news" class="links">Graph Theory</a>
            <a href="category.php?category=gaming" class="links">Number Theory</a>
            <a href="category.php?category=sports" class="links">Object Oriented Programming</a>
            <a href="category.php?category=design" class="links">Competitive programming</a>
            <a href="category.php?category=Algorithm" class="links">Education</a>
